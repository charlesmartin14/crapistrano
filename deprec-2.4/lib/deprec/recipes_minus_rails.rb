...
# require "#{File.dirname(__FILE__)}/recipes/sphinx"  # revive, plus / or xapian
...
require "#{File.dirname(__FILE__)}/recipes/xapian"
require "#{File.dirname(__FILE__)}/recipes/memcached"
require "#{File.dirname(__FILE__)}/recipes/s3cmd"
